...
/*androidk3 l00217238 resert frame type of hevc stream @add 2014-04-02 begin*/
#ifdef VIDEO_DEC_HEVC
/* modified by xwx271409 for DTS2015090108879 at 2015.09.11 begin */
...
/* modified by xwx271409 for DTS2015090108879 at 2015.09.11 end */
#endif
/*androidk3 l00217238 resert frame type of hevc stream @add 2014-04-02 end*/

/************  added by x00293649 for DTS2014071600834 @2014-09-16  start ***********/
...
/************  added by x00293649 for DTS2014071600834 @2014-09-16 end ***********/

static int flv_read_packet(AVFormatContext *s, AVPacket *pkt)
{
    FLVContext *flv = s->priv_data;
    int ret, i, type, size, flags, frame_type=0;
    int stream_type=-1;
...
/*androidk3 l00217238 resert frame type of hevc stream @add 2014-04-02 begin*/
            ...
            if (FLV_CODECID_HEVC == (flags & FLV_VIDEO_CODECID_MASK))
            {
                ...
                frame_type = hevc_find_frame_type(s->pb->buf_ptr, size, frame_type, s->pb->buf_end);  /* added formal parameter s->pb->buf_end by xwx271409 for DTS201509010879 at 2015.09.11 */
